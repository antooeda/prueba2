...
public class CredencialController {
    ...
    @GetMapping("/login")
    public String muestraLogin(HttpServletRequest request, Model model){
    ...
    @PostMapping("login")
    public String login( Model model,@ModelAttribute Credencial c,HttpServletRequest request){
