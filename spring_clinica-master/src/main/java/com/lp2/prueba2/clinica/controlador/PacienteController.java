...
public class PacienteController {
    ...
    public String muestraPacientes( Model model, HttpServletRequest request){
    ...
    public String mostrarForm(Model model,HttpServletRequest request){
        Credencial c = (Credencial) request.getSession().getAttribute("medicoLogueado");
        if(c == null){
            return "redirect:/login";
        }else {
    ...
    public String nuevoPaciente(@ModelAttribute Paciente p,HttpServletRequest request){
      Credencial c = (Credencial) request.getSession().getAttribute("medicoLogueado");
        if(c == null){
            return "redirect:/login";
        }else {
